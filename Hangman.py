...
def getRandomWord():
    words = ['dog', 'lion', 'cat', 'tiger', 'giraffe', 'antelope', 'panther', 'deer',
             'reindeer', 'crocodile', 'elephant', 'sparrow', 'catepillar', 'shark', 'parrot', 'bear', 'cow']
...
def displayBoard(hang, missedLetters, correctLetters, secretWord):
    ...
    print(hang[len(missedLetters)])#picture of hang 
    print()
